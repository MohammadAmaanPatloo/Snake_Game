...
let inputDir = {x: 0, y: 0};  // Represents the current direction of the snake
const foodSound = new Audio('music/food.mp3'); // Sound when the snake eats food
...
let speed = 19; // Speed of the game
...
// Update the snake and food positions, and handle game over conditions
function gameEngine(){
    ...
    // Add appropriate CSS classes to style the snake
        if(index === 0){
...
musicSound.play(); // Play the background music
